<template>
	<div>
<!-- 头部 -->
<el-header class="border-bottom d-flex align-items-center" style="margin-top: -8px;margin-left: -20px;margin-right: -20px;">
  <el-select size="small" v-model="form.select"
  placeholder="请选择图片排序方式" class="mr-2">
	<el-option label="区域一" value="shanghai"></el-option>
	<el-option label="区域二" value="beijing"></el-option>
  </el-select>
  <el-input v-model="form.keyword" 
  size="small" style="width: 200px;" class="mr-2" 
  placeholder="输入相册名称"></el-input>
  <el-button size="small" type="success" class="mr-auto">搜索</el-button>
  <!-- 批量删除图片 -->
  ...
  @click="uploadModel = true">上传图片</el-button>
	  ...
	  <el-container style="margin-left: -20px;margin-right: -20px;">
		...
		class="border-right bg-light"
		style="overflow-y: auto;position: absolute;top: 106px;bottom: 60px;">
		...
		<el-container>
		  <!-- 内容 -->
		  <el-main style="overflow-y: auto;position: absolute;left: 200px;right: 0;bottom: 60px;top: 106px;">
			 
			 
			 <el-row :gutter="10">
				<el-col :span="12" :lg="4" :md="6" :sm="8"
	  ...
	  <el-footer class="border-top d-flex align-items-center p-0 bg-white" style="position: absolute;bottom: 0;left: 0;right: 0;">
		...
		<el-dialog title="创建相册" :visible.sync="createModel">
		  ...
		  <div slot="footer" class="dialog-footer">
			<el-button @click="hideCreateModel">取 消</el-button>
			<el-button type="primary" @click="hideCreateModel">确 定</el-button>
		  </div>
		</el-dialog>
		...
		methods: {
			...
			getData() {
				for (let i = 0; i < 20; i++) {
					...
					this.imageList.push({
						id: id,
						url: `https://tangzhe123-com.oss-cn-shenzhen.aliyuncs.com/Appstatic/qsbk/demo/datapic/${Math.floor(Math.random()*47)}.jpg`,
						name: '图片' + id,
						ischeck: false,
						checkorder: 0,
					});
